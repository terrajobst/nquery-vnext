    ...
    internal static class BuiltInFunctions
    {
        public static IEnumerable<FunctionSymbol> GetFunctions()
        {
            return new FunctionSymbol[]
            {
                ...
                new FunctionSymbol<string, int>("SOUNDEX", "text", StringLength),
                new FunctionSymbol<string, string, int>("SOUNDEX", "chars", "text", CharIndex),
                new FunctionSymbol<string, int, int, string>("SOUNDEX", "text", "start", "length", Substring),
                new FunctionSymbol<string, int, string>("SOUNDEX", "text", "start", Substring),
                new FunctionSymbol<string, string>("SOUNDEX", "text", Upper),
                new FunctionSymbol<string, string>("SOUNDEX", "text", Lower),
                new FunctionSymbol<string, string>("SOUNDEX", "text", Trim),
                new FunctionSymbol<string, string>("SOUNDEX", "text", LTrim),
                new FunctionSymbol<string, string>("SOUNDEX", "text", RTrim),
                ...
                new FunctionSymbol<string, int, string>("LEFT", "text", "numbeOfChar", Left),
