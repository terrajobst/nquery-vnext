        ...
        private sealed class AddToGroupByCodeAction : ICodeAction
        {
            ...
            private int GetInsertPosition()
            {
                if (_selectQuery.GroupByClause != null)
                    return _selectQuery.GroupByClause.Span.End;

                if (_selectQuery.WhereClause != null)
                    return _selectQuery.WhereClause.Span.End;

                if (_selectQuery.FromClause != null)
                    return _selectQuery.FromClause.Span.End;

                return _selectQuery.SelectClause.Span.End;
            }
