...
internal sealed class SumAggregateDefinition : AggregateDefinition
{
    ...
    private sealed class SumAggregatable : IAggregatable
    {
        ...
        private readonly VariableDefinition _leftParameter;
        private readonly VariableDefinition _rightParameter;
        private readonly Expression<object> _convertInputToSumExpression;
        private readonly VariableDefinition _conversionInputVariable;

        public SumAggregatable(Expression<object> sumExpression, VariableDefinition leftParameter, VariableDefinition rightParameter, Expression<object> convertInputToSumExpression, VariableDefinition conversionInputVariable)
        {
    ...
    private sealed class SumAggregator : IAggregator
    {
        ...
        public SumAggregator(Expression<object> addExpression, VariableDefinition leftParameter, VariableDefinition rightParameter, Expression<object> convertInputToSumExpression, VariableDefinition conversionInputVariable)
        {
