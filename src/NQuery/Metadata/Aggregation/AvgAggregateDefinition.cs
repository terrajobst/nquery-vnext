...
internal sealed class AvgAggregateDefinition : AggregateDefinition
{
    ...
    private sealed class AvgAggregatable : IAggregatable
    {
        ...
        private readonly VariableDefinition _sumArgument;
        private readonly VariableDefinition _countArgument;

        public AvgAggregatable(IAggregatable sumAggregatable, IAggregatable countAggregatable, Expression<object> divisionExpression, VariableDefinition sumArgument, VariableDefinition countArgument)
        {
    ...
    private sealed class AvgAggregator : IAggregator
    {
        ...
        public AvgAggregator(IAggregator sumAggregator, IAggregator countAggregator, Expression<object> divisionExpression, VariableDefinition sumArgument, VariableDefinition countArgument)
        {
